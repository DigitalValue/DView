...
function SVGIcon() {
    ...
    const Icons = {
        ...
        mouse_pointer: [
            m("path", { d: "M4.037 4.688a.495.495 0 0 1 .651-.651l16 6.5a.5.5 0 0 1-.063.947l-6.124 1.58a2 2 0 0 0-1.438 1.435l-1.579 6.126a.5.5 0 0 1-.947.063z" })
        ],
        notebook: [
        ...
        party: [
            m("path", {d:"M5.8 11.3 2 22l10.7-3.79"}),
            m("path", {d:"M4 3h.01"}),
            m("path", {d:"M22 8h.01"}),
            m("path", {d:"M15 2h.01"}),
            m("path", {d:"M22 20h.01"}),
            m("path", {d:"m22 2-2.24.75a2.9 2.9 0 0 0-1.96 3.12c.1.86-.57 1.63-1.45 1.63h-.38c-.86 0-1.6.6-1.76 1.44L14 10"}),
            m("path", {d:"m22 13-.82-.33c-.86-.34-1.82.2-1.98 1.11c-.11.7-.72 1.22-1.43 1.22H17"}),
